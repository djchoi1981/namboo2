    ...
    <div class="app-container">
        ...
        <aside class="sidebar">
            ...
            <nav>
                ...
                <a href="#" id="nav-committee" class="nav-item"><i class="ph ph-users-three"></i> 위원회/부서 일정</a>
                <a href="#" id="nav-cell" class="nav-item"><i class="ph ph-users"></i> 셀/모임 장소예약</a>
                <a href="#" id="nav-vehicle" class="nav-item"><i class="ph ph-car"></i> 차량 운영예약</a>
                ...
                <div class="header-left">
                    ...
                    <div class="month-navigation">
                        ...
                        <select id="calendar-filter" class="filter-select" style="margin-left: 1rem;">
                            ...
                            <option value="committee">위원회/부서 일정만</option>
                            <option value="cell">셀/모임 장소예약만</option>
                            <option value="vehicle">차량 운영예약만</option>
                        </select>
                    </div>
                </div>
            ...
            <div class="content-grid">
                ...
                <section class="list-section card" id="committee-view" style="display: none;">
                    <div class="card-header">
                        <h3><i class="ph ph-users-three"></i> 위원회/부서 일정 현황</h3>
                ...
                <section class="list-section card" id="cell-view" style="display: none;">
                    <div class="card-header">
                        <h3><i class="ph ph-users"></i> 셀/모임 장소예약 현황</h3>
                        <div class="filter-group" style="margin-top: 1rem; display: flex; gap: 0.5rem;">
                ...
                <section class="list-section card" id="vehicle-view" style="display: none;">
                    <div class="card-header">
                        <h3><i class="ph ph-car"></i> 차량 배차 현황</h3>
                ...
                <section class="admin-section card" id="admin-view" style="display: none;">
                    <div class="card-header">
                        ...
                        <p>예약 목록을 일괄 관리하고, 조직도를 편집하며, 관리자 비밀번호를 변경할 수 있습니다.</p>
                    </div>
                        ...
                        <div class="admin-panel" style="grid-column: 1 / -1;">
                            ...
                            <div class="filter-group" style="margin-bottom: 1rem;">
                                <select id="admin-event-filter" class="filter-select">
                                    <option value="all">모든 예약 보기</option>
                                    <option value="committee">위원회/부서 일정만</option>
                                    <option value="cell">셀/모임 예약만</option>
                                    <option value="vehicle">차량 운영예약만</option>
                                </select>
                            </div>
